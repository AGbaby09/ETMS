...
export const ContextVarialesProvider = ({children}) => {
    ...
    return (
        <ContextVariales.Provider value={{ callReview, setCallReview, callTalk, setCallTalk, openRide, setOpenRide, role, setRole, domain, openV, setOpenV, vData, setVData, rData, setRData }} >
            {children}
